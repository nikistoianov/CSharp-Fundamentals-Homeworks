...
public class GameController
{
    ...
    public void GiveInputToGameController(string input)
    {
        ...
        if (data[0].Equals("Soldier"))
        {
            ...
            //    {
            //        case "Ranker":
            //            var ranker = SoldiersFactory.GenerateRanker(name, age, experience, speed, endurance, motivation, maxWeight);
            //            AddSoldierToArmy(ranker, type);
            //            break;
            //        case "Corporal":
            //            var corporal = SoldiersFactory.GenerateCorporal(name, age, experience, speed, endurance, motivation, maxWeight);
            //            AddSoldierToArmy(corporal, type);
            //            break;
            //        case "Special-Force":
            //            var specialForce = SoldiersFactory.GenerateSpecialForce(name, age, experience, speed, endurance, motivation, maxWeight);
