namespace _10.The_Heigan_Dance
{
    ...
    public class TheHeiganDance
    {
        public static void Main()
        {
            ...
            //bool[,] chamberCloudLastTurn = new bool[15, 15];
            bool activeCloudDamage = false;
            ...
            while (heiganHealth > 0 && playerHealth > 0)
            {
                    ...
                    chamberCloud[playerRow, playerCol])
                {
                    ...
                    //if (chamberCloudLastTurn[playerRow, playerCol] && playerHealth > 0)
                    if (activeCloudDamage && playerHealth > 0)
                    {
                    ...
                    if (chamberCloud[playerRow, playerCol] && playerHealth > 0)
                    {
                        lastDamage = "Plague Cloud";
                        playerHealth -= 3500;
                        activeCloudDamage = true;
                    }
                    else
                    {
                        activeCloudDamage = false;
                    }
                    ...
                    //chamberCloudLastTurn = chamberCloud;
                }
            }
